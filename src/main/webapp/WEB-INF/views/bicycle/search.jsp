	...
	<div class="row">
		...
		<div class="col-sm-2" style="background-color: #eeeeee; padding-top: 1%; padding-bottom: 20%">
			<ul class="nav nav-pills nav-stacked">
				<li role="presentation" class="active"><a><span style="font-size: medium">대여소 찾기/대여</span></a></li>
				...
				<li role="presentation"><a><span style="color: #aaaaaa; font-size: medium">대여 완료</span></a></li>
			</ul>
		</div>
		<div class="col-sm-6">
			<!-- 다음 지도 시작 -->
