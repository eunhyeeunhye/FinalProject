...
<!-- 
	...
	작성일 : 2016.07.19
	내용 : 이용안내 페이지
	수정내역 : 2016.08.04 이용안내 페이지 image변경
 -->
...
<body>
	...
	<div class="row">
		...
		<div class="col-sm-2"
			style="background-color: #eeeeee; padding-top: 1%; padding-bottom: 35%">
			<ul class="nav nav-pills nav-stacked" role="tablist">
				...
				<li role="presentation" class="active"><a href="/service_guide/HowToUse"
					aria-conrols="faq" role="tab"><span
						style="font-size: medium">이용방법</span></a></li>
			</ul>
		</div>
		<div class="col-sm-5">
			<img src="/resources/images/information/useInfo.png">
		</div>
